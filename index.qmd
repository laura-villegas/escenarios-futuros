---
title: "Modelos de nichos ecológicos bajo escenarios de cambio climático"
author: "Laura"
format: html
editor: visual
---
...
# Cargar java para maxent
library(rJava)
```
# Obtención de datos de presencia

```{r}
#| label: obtener-presencia
#| warning: false
#| message: false
#| eval: true
...
# Crear un objeto sf a partir del dataframe (este contiene las geometrias)
presencia <- st_as_sf(
  presencia,
...
## Generación de conjuntos de datos de entrenamiento y evaluación
...
### Calcular la diferencia entre los dos modelos
